...
const AlliancePopup04 = ({ setIsPopup, setIsChk, active }) => {
    return (
            ...
            <div className="box">
                ...
                <div className="desc">
                    <ul>
                        ...
                        <li>
                            <b>* 귀하는 개인정보 수집에 동의를 거부할 권리가 있으며, 동의 거부 시 입점 제의 상담 신청이 불가합니다.</b>
                        </li>
                    </ul>
                </div>
                {/* 물결버튼 */}
...
export default AlliancePopup04;
